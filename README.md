...
Pipelines > pkg_tree_modeling > click on three dots in upper right corner > Status badge > Branch: develop > replace this instruction with a Sample markdown.
...
```bash
from tree_modeling import multiply
result = multiply(2, 3)
print(result)
```
